...
-- Insert yearly budgets (use actual user ID from above - replace 2 with Billy's actual ID)
...
-- Insert customers (use Said's ID - replace 1 with actual ID)
...
-- Insert forecasts (use Billy's ID - replace 2 with actual ID)
